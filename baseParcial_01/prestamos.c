...
*
*/
int prestamo_buscarIdSocio(Prestamo array[], int size, int valorBuscado, int* posicion)                    //cambiar prestamo
{
    int retorno=-1;
    int i;
    if(array!= NULL && size>=0)
...
*
*/
int prestamo_buscarIdLibro(Prestamo array[], int size, int valorBuscado, int* posicion)                    //cambiar prestamo
{
    int retorno=-1;
    int i;
    if(array!=NULL && size>=0)
    {
        for(i=0;i<size;i++)
        {
            if(array[i].isEmpty==1)
                continue;
            else if(array[i].idLibro==valorBuscado)                                        //cambiar campo varString
            {
                retorno=0;
                *posicion=i;
                break;
...
*
*/
int prestamo_alta(Prestamo array[], Socios arraySocios[], int sizeSocio, Libro arrayLibro[],int sizeLibro,int size, int* contadorID)                          //cambiar prestamo
{
    int retorno=-1;
    int posicion;
    if(array!=NULL && size>0 && contadorID!=NULL)
    {
        ...
        else
        {
            ...
            utn_getUnsignedInt("\nIngrese ID del libro: ","\nError",1,sizeof(int),1,10,1,&array[posicion].idLibro);
            printf("\n Posicion: %d\n ID: %d\n ID del Socio: %d\n ID del Libro: %d\n",
    ...
    if(array!=NULL && sizeArray>0)
    {
        for(i=0;i<sizeArray;i++)
        {
            if(array[i].idUnico==valorBuscado)                                                        //cambiar si no se busca por ID
            {
                ...
                array[i].idLibro=0;                                                               //cambiar campo varInt
                array[i].idSocio=0;                                                             //cambiar campo varFloat
            ...
            {       //copiar printf de alta
                ...
                switch(opcion)
                {
                    case 'A':
                        ...
                        break;
                    case 'B':
                        utn_getUnsignedInt("\nID Libro: ","\nError",1,sizeof(int),1,1,1,&array[posicion].idLibro);           //mensaje + cambiar campo varInt
                        break;
    ...
    if(array!=NULL && size>=0)
    {
        for(i=0;i<size;i++)
        {
            if(array[i].isEmpty==1)
                ...
                printf("\n ID: %d\n IS Socio: %d\n ID Libro: %d\n",
                       array[i].idUnico,array[i].idSocio,array[i].idLibro);
        }
        retorno=0;
    }
    return retorno;
