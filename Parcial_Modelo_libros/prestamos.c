...
void prestamo_mock(Prestamo arrayPrestamo[], int size,int *contadorId)                      //cambiar prestamo
{
    ...
    arrayPrestamo[0].varInt=0;
    arrayPrestamo[0].varFloat=0;
    strcpy(arrayPrestamo[0].varLongString,"CCCCC");
    strcpy(arrayPrestamo[0].varString,"CCCCC");
    *contadorId++;

    arrayPrestamo[1].idUnico=1;
    arrayPrestamo[1].isEmpty=0;
    arrayPrestamo[1].varInt=0;
    arrayPrestamo[1].varFloat=0;
    strcpy(arrayPrestamo[1].varLongString,"AAAAA");
    strcpy(arrayPrestamo[1].varString,"AAAAA");
    *contadorId++;

    arrayPrestamo[2].idUnico=2;
    arrayPrestamo[2].isEmpty=0;
    arrayPrestamo[2].varInt=0;
    arrayPrestamo[2].varFloat=20;
    strcpy(arrayPrestamo[2].varLongString,"BBBBB");
    strcpy(arrayPrestamo[2].varString,"BBBBBB");
    *contadorId++;

    arrayPrestamo[3].idUnico=3;
    arrayPrestamo[3].isEmpty=0;
    arrayPrestamo[3].varInt=0;
    arrayPrestamo[3].varFloat=10;
    strcpy(arrayPrestamo[3].varLongString,"BBBBB");
    strcpy(arrayPrestamo[3].varString,"BBBBBB");
    contadorId++;
}
