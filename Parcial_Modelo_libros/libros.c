...
void libro_mock(Libro arrayLibro[], int size,int *contadorId)                      //cambiar libro
{
    ...
    arrayLibro[0].varInt=0;
    arrayLibro[0].varFloat=0;
    strcpy(arrayLibro[0].varLongString,"CCCCC");
    strcpy(arrayLibro[0].varString,"CCCCC");
    *contadorId++;

    arrayLibro[1].idUnico=1;
    arrayLibro[1].isEmpty=0;
    arrayLibro[1].varInt=0;
    arrayLibro[1].varFloat=0;
    strcpy(arrayLibro[1].varLongString,"AAAAA");
    strcpy(arrayLibro[1].varString,"AAAAA");
    *contadorId++;

    arrayLibro[2].idUnico=2;
    arrayLibro[2].isEmpty=0;
    arrayLibro[2].varInt=0;
    arrayLibro[2].varFloat=20;
    strcpy(arrayLibro[2].varLongString,"BBBBB");
    strcpy(arrayLibro[2].varString,"BBBBBB");
    *contadorId++;

    arrayLibro[3].idUnico=3;
    arrayLibro[3].isEmpty=0;
    arrayLibro[3].varInt=0;
    arrayLibro[3].varFloat=10;
    strcpy(arrayLibro[3].varLongString,"BBBBB");
    strcpy(arrayLibro[3].varString,"BBBBBB");
    contadorId++;
}
