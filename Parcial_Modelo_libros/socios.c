...
void socio_mock(Socio arraySocio[], int size,int *contadorId)                      //cambiar socio
{
    ...
    strcpy(arraySocio[0].varLongString,"CCCCC");
    strcpy(arraySocio[0].varString,"CCCCC");
    *contadorId++;
    ...
    strcpy(arraySocio[1].varLongString,"AAAAA");
    strcpy(arraySocio[1].varString,"AAAAA");
    *contadorId++;
    ...
    strcpy(arraySocio[2].varLongString,"BBBBB");
    strcpy(arraySocio[2].varString,"BBBBBB");
    *contadorId++;
    ...
    strcpy(arraySocio[3].varLongString,"BBBBB");
    strcpy(arraySocio[3].varString,"BBBBBB");
    contadorId++;
}
